      ...
      <BrowserRouter>
        <Routes>
          <Route path="/" element={<Layout />}>
            ...
            <Route
              path="product/NFC-Base-Card"
              element={
                <Product
                  productTitle="کارت ویزیت ان اف سی Base"
                  productDesc="کارت ویزیت های هوشمند آماده،محصول بصرفه کهکشان ان اف سی"
                  productID={1}
                  productPrice="450,000"
                  colors="آبی, بنفش, زرد, سبز, سفید, صورتی, طوسی, قرمز, مشکی, نارنجی"
                />
              }
            />
